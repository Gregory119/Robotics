...
namespace CTRL
{
  ...
  public:
    ...
    void setVelocityParams(const RCStepVelocityManager::VelocityLimitParams&); // useful for ESCs, which use the position here as the velocity of the motor
    ...
    static int getMidPos();
    static int getRangePos();
    static bool isPosValid(int); // uses internal max and min for limits
